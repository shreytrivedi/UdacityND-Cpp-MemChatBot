...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot chatBotInst("../images/chatbot.png"); 
    chatBotInst.SetRootNode(rootNode);
    chatBotInst.SetChatLogicHandle(this);
    rootNode->MoveChatbotHere(std::move(chatBotInst));
